    ...
    UUPSUpgradeable
{
    ...
    function bid(uint256 bidAmount) external returns (address) {
        ...
        require(bidAmount <= tmpToken.allowance(msg.sender, address(this)),"Bid amount was accepted, but bid failed as not enough balance/allowance to transfer erc20 token TMP");
        //Set the bidder as winner and Transfer the NFT to bidder and Transfer the bid amount erc20 to owner
        winner = msg.sender;
